...
function OnPlayerDisconnect(event)
    ...
    if isBot == 1 then
        if config.botNotification then
            ScriptPrintMessageChatAll("\x07 \x07 [ " .. config.nameTag .. " ] " .. language[config.language][1] .. "\x08 \x08" .. nameDisconnect .. "\x07 \x07 " .. language[config.language][3])
        end
    else
        ScriptPrintMessageChatAll("\x07 \x07 [ " .. config.nameTag .. " ] " .. language[config.language][2] .. "\x08 \x08" .. nameDisconnect .. "\x07 \x07 " .. language[config.language][3])
    end
end
